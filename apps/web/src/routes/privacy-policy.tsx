		...
		<div className="container mx-auto max-w-4xl px-4 py-6">
			...
			<div className="space-y-6 text-sm leading-6">
				<section className="rounded-lg border p-4">
					<h2 className="mb-2 font-medium text-base">1. What this app does</h2>
					<p>
				...
				<section className="rounded-lg border p-4">
					...
					<p>
						We process platform-provided identifiers and comment data needed to
						return requested analytics results, such as comment text, comment
						ID, author display name, timestamps, like counts, and reply counts.
					</p>
				</section>
				...
				<section className="rounded-lg border p-4">
					...
					<p>
						...
						retrieval and analysis inside Collector. We do not use this data to
						post content, run ads, or sell user data.
					</p>
				</section>
