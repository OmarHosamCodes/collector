...
export const Route = createFileRoute("/terms-of-service")({
	head: () => ({
		meta: [
			{
				title: "Terms of Service | Collector",
				description: "Terms governing use of the Collector web app.",
			},
			{ property: "og:title", content: "Terms of Service | Collector" },
			{
				property: "og:description",
				content: "Terms governing use of the Collector web app.",
			},
			{ property: "og:type", content: "website" },
			{ property: "og:url", content: "https://collector.app/terms-of-service" },
			{ name: "twitter:card", content: "summary_large_image" },
			{ name: "twitter:title", content: "Terms of Service | Collector" },
			{
		...
		link: [
			{ rel: "canonical", href: "https://collector.app/terms-of-service" },
		],
	}),
				...
				<div className="space-y-6 text-sm leading-6">
					...
					<section className="rounded-lg border p-4">
						...
						<p>
							...
							data. You may not use Collector to violate laws, platform
